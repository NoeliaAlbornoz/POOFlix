...
public class PooFlix {
        ...
        public void inicializarBreakingBad() {
                ...
                epi.setDescripcion(
                                "Walt y Jesse intentan deshacerse de los dos cuerpos en la caravana lo que se vuelve cada vez más complicado cuando uno de ellos, Krazy-8, se despierta.");
                temp.getEpisodios().add(epi);
        ...
        public void inicializarLucifer() {
                ...
                serie.setDescripcion(
                                "Sinopsis: Harto del infierno, Lucifer abandona su trono en el averno y se marcha a Los Ángeles, donde empieza a trabajar como detective de homicidios.");
                // serie.descripcion = "Sinopsis: Harto del infierno, Lucifer abandona su trono
                // en el averno y se marcha a Los Ángeles, donde empieza a trabajar como
                ...
                // epi.duracionEnMinutos = 58;
                epi.setDescripcion(
                                "Lucifer Morningstar, el gobernante retirado del infierno, utiliza sus poderes de persuasión para ayudar a la detective Chloe Decker a detener al verdadero culpable de un asesinato.");
                temp.getEpisodios().add(epi);
        ...
        public void inicializarGoodDoctor() {
                ...
                epi.setDescripcion(
                                "La junta de directores del Hospital San José St. Bonaventure debe decidir si permite la contratación de un joven médico con síndrome de Savant y autismo entre su personal quirúrgico.");
                temp.getEpisodios().add(epi);

                epi = new Episodio(2, "Mount Rushmore.", 45);
                epi.setDescripcion(
                                "La atención a los detalles del doctor Murphy complica su primer día en el Hospital St. Bonaventure. Mientras tanto, Claire aprende una valiosa lección sobre la honestidad.");
                temp.getEpisodios().add(epi);
                ...
                websodio.setDescripcion(
                                "Precuela. Shaun atraviesa una penosa niñez y sólo encuentra paz en la compañía de su hermano.");
                ...
                epi.setDescripcion(
                                "La continua vacilación de Neil para correr riesgos lo hace enfrentarse con Audrey por el tratamiento de Wren, una joven que planea viajar a la luna y por lo tanto necesita ambos pulmones intactos; trabajando juntos, Audrey y Neil realizan con éxito la cirugía.");
                temp.getEpisodios().add(epi);

                epi = new Episodio(12, "Mutations.", 45);
                epi.setDescripcion(
                                "La Dra. Audrey Lim, el Dr. Shaun Murphy y la Dra. Morgan Reznick tratan a un corredor de 25 años que sufre de una severa hinchazón; pero cuando las cosas empeoran, el Dr. Shaun Murphy solicita la ayuda de la Dra. Carly Lever.");
                temp.getEpisodios().add(epi);

                websodio = new Websodio(4, "Claire's vocation", 12, "http://websodio.com");
                websodio.setDescripcion(
                                "Precuela. Una joven Claire descubre un libro de anatomía en la biblioteca de su abuelo, materia que le estaba prohibida estudiar.");
                temp.getEpisodios().add(websodio);
        }
